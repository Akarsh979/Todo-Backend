...
// const forgotPassword: RequestHandler = asyncHandler(async (req: ProtectedRequest, res: Response) => {
...
// const resetPassword: RequestHandler = asyncHandler(async (req: ProtectedRequest, res: Response) => {
